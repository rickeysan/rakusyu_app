...
for($day = 1; $day <=$day_count;$day++,$youbi++){
    ...
    // debug('$compare_dateの値'.$compare_date);
    // 進歩状況のデータがあるか判定
    foreach($userHabitLog as $key=>$val){
        if($val['date'] == $compare_date){
            // debug($compare_date.'この日は、データがあります');
            ...
            <div class="col2-wrap">
                <div class="col2-section-wrap">
                    ...
                    <div class="archive-form">
                        ...
                        <p class="archive-form-info"><?php if($record_today) echo '本日分はすでに記録しています';?>
                            ...
                            <div>
                                ...
                                <p  class="complete-form-err">
                                    <?php if(!empty($err_msg['record_date'])) echo $err_msg['record_date'];?>
                                </p>
                            </div>
                                <span class="archive-comment-title">任意：コメント</span>
                                <textarea name="record_comment" id="" cols="30" rows="10"></textarea>
                                <input type="submit" value="記録する" <?php if($record_today) echo 'disabled';?>>
                        </form>
                    ...
                    <?php };?>
                        ...
                        <div class="col2-habit-post co2-habit-post-no-form">
                        ...
                        <table class="record-calender table-bordered mb-5">
                            <tbody>
                                <tr>
                                    <th>日</th>
                                    <th>月</th>
