                ...
                <form action="" method="post">
                    ...
                    <div class="text-field-wrap">
                        ...
                        <div class="text-field-footer">
                            <p class="text-field-msg"><?php if(!empty($err_msg['old_pass'])) echo $err_msg['old_pass'];?></p>
                        </div>  
                    ...
                    <div class="text-field-wrap">
                        ...
                        <div class="text-field-footer">
                            <p class="text-field-info">
                                ※半角英字と数字を組み合わせた8〜20文字でご入力ください。
                            </p>
                            <p class="text-field-msg"><?php if(!empty($err_msg['new_pass'])) echo $err_msg['new_pass'];?></p>
                        </div>  
                    ...
                    <div class="text-field-wrap">
                        ...
                        <div class="text-field-footer">
                            <p class="text-field-msg"><?php if(!empty($err_msg['retype_new_pass'])) echo $err_msg['retype_new_pass'];?></p>
                        </div>  
