                                ...
                                <select name="category" id="">
                                    <option value="0">選択してください</option>
                                        <?php foreach($category_list as $key=>$val):?>
                                            <option value="<?php echo $val['id'];?>"  style="<?php if($category_sort==$val['id']) echo 'selected';?>"><?php echo $val['name'];?></option>
                                        <?php endforeach;?>
                                </select>
                            </div>
                            <div class="search-bar-item-wrap">    
                    ...
                    <div class="paging-bar-section">
                        <div class="paging-bar-wrap">
                            ...
                            <?php if($currentPage != 1):?>
                                <li class="paging-bar-item"><a href="search.php<?php echo (empty($_GET['p'])) ? appendGetParam().'?p=1' : appendGetParam(array('p')).'&p=1'; ?>">&lt;</a></li>
                            <?php endif; ?>
                            <?php
                            for($i=$minPageNum; $i<=$maxPageNum;$i++):
                            ?>
                                <li class="paging-bar-item" <?php if($currentPage == $i) echo 'active';?>>
                                    <a href="search.php<?php debug('ページング:$_GETの中身：'.print_r($_GET,true)); echo (empty($_GET['p'])) ? appendGetParam().'?p='.$i : appendGetParam(array('p')).'&p='.$i; ?>">
                                        <?php echo $i;?>
                                    </a>
                                </li>
                            <?php endfor; ?>
                            <?php if($currentPage != $totalPage):?>
                                <li class="paging-bar-item"><a href="search.php<?php echo (empty($_GET['p'])) ? appendGetParam().'?p='.$totalPage : appendGetParam(array('p')).'&p='.$totalPage; ?>">&gt;</a></li>
                            <?php endif; ?>
