                ...
                <form action="" method="post">
                    ...
                    <div class="text-field-wrap">
                        <div class="text-field-upper">
                            ...
                            <input type="password" name="retype_pass" value="<?php if(!empty($_POST['retype_pass'])) echo $_POST['retype_pass'];?>">
                        </div>
                        <div class="text-field-footer">
                            <p class="text-field-msg"><?php if(!empty($err_msg['retype_pass'])) echo $err_msg['retype_pass'];?></p>
                        </div>  
